...
public class EventHandler {
    ...
    @Inject
    public EventHandler(Map<String,Set<EventTransformer>> eventTransformers,EventIngestionConfiguration eventIngestionConfiguration,StorageAdaptor storageAdaptor){
